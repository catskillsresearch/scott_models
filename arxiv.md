...
| `infoSys_constructions_equiv`             | products, sums, function space | 1972 **3.3**, 1982 constructions     | **Partial** — product: `\|A\| × \|B\| ≃o \|A×B\|` (`InfoSysConstructions.lean`); sum / function space not yet |
